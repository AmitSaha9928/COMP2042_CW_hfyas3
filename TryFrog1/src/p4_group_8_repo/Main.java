				...
				if(event.getCode() == KeyCode.SPACE) {
					/* Gme starts*/
					 background = new MyStage();
						...
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log3.png", 150, 0, 166, 0.75));
						...
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/logs.png", 300, 800, 276, -2));
						...
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log3.png", 150, 570, 329, 0.75));
						...
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 200, 100, 1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 0, 100, 1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 100, 120, -1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 200, 120, -1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 100, 140, 1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 200, 140, 1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 100, 160, -1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 300, 160, -1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 100, 180, 1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 200, 180, 1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 100, 200, -1));
						//background.add(new Log("file:src/p4_group_8_repo/p4_group_8_repo/log2.png", 200, 200, -1));
						...
						background.add(new Obstacle("file:src/p4_group_8_repoimg/truck1Right.png", 300, 649, 1, 120, 120));
						...
						background.add(new Obstacle("file:src/p4_group_8_repo/imgs/car1Left.png", 550, 597, -1, 50, 50));
						...
						background.add(new Digit(0, 30, 560, 25));
